...
exports.getMovieWithID = function (req, res, next) {
  ...
  // res.send(theMovie);
  res.render("showMovieWithId", { id : id, movies : theMovie, genres : allGenres})
...
exports.search = function (req, res, next) {
  ...
  const allGenres = movieModel.getAllMoviesGenre();
  // res.send(theMovie);
  res.render("showMovieSearch", { movies : theMovies, genres : allGenres, query : id ? id : genre ? genre : title ? title : ""})
};
